export const translations = {
  en: {
    ...
    switchToHandwritten: "Switch to handwritten note",
    drawingReady: "Drawing ready to submit!",
    ...
    willYouBeThere: "Will you be there with us?",
  ...
  ar: {
    ...
    drawingReady: "الرسم جاهز للإرسال!",
